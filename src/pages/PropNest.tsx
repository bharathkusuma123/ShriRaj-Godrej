...
// Home Section with Single Static Banner
// Home Section with Clean Banner
const HomeSection = () => {
  const properties = [
  ...
  return (
    <section id="home" className="pt-16">
      {/* Clean Banner with Subtle Overlay */}
      <div className="relative h-[500px] md:h-[600px] overflow-hidden">
        ...
        >
          {/* Simple dark overlay for text readability - no colors! */}
        ...
        <div className="relative h-full container mx-auto px-4 flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <button className="bg-white text-gray-900 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition transform hover:scale-105">
              Explore Properties
            </button>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Hand-picked properties you'll love</p>
          </div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 text-center px-4">
        ...
        <div className="flex gap-4 justify-center">
          <button className="bg-background text-foreground font-semibold px-8 py-3 rounded-full hover:opacity-90 transition transform hover:scale-105">
            Get Started
          </button>
          <button className="border-2 border-white text-white font-semibold px-8 py-3 rounded-full hover:bg-white/10 transition transform hover:scale-105">
            Learn More
          </button>
        </div>
      </section>
