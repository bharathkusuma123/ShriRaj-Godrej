...
>
  <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
    <button
      ...
      style={{ color: wf.secondary }} // Always use secondary color (assuming it's dark)
    >
      WALLFORT.
    </button>
    ...
    <div className="hidden lg:flex items-center gap-1">
      {navItems.map((item) => (
        <button
          ...
          style={{ color: wf.dark }} // Always use dark color
        >
          {item}
          <span
    ...
    <button className="lg:hidden" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
      {mobileMenuOpen ? (
        <X className="w-6 h-6" style={{ color: wf.dark }} /> // Always use dark color
      ) : (
        <Menu className="w-6 h-6" style={{ color: wf.dark }} /> // Always use dark color
      )}
    </button>
  </div>
    ...
    <div className="lg:hidden px-4 py-3 space-y-3" style={{ background: "rgba(255,255,255,0.95)" }}>
      {navItems.map((item) => (
        <button 
          ...
          style={{ color: wf.dark }} // Dark text for mobile menu
        >
          {item}
        </button>
      ))}
      {/* Godrej button for mobile - same style as desktop */}
      <div className="pt-2">
        <Link
          to="/"
...
<section className="py-20 px-4">
  <div className="max-w-6xl mx-auto text-center">
    <SectionTitle title="Project Highlights" subtitle="Premium plotted development at WALLFORT Residency, Boriyakala" />
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
      ...
      >
        ...
        <p className="text-xs" style={{ color: wf.textLight }}>Successfully developed portfolio</p>
      </div>
      ...
      >
        ...
        <p className="text-xs" style={{ color: wf.textLight }}>Ongoing premium projects</p>
      </div>
      ...
      >
        ...
        <p className="text-xs" style={{ color: wf.textLight }}>Trusted by families across Raipur</p>
      </div>
      ...
      >
        ...
        <h3 className="text-2xl font-bold mb-1" style={{ fontFamily: "'Poppins', sans-serif", color: wf.secondary }}>17 YEARS</h3>
        <p className="text-sm font-medium mb-2" style={{ color: wf.primary }}>OF RICH EXPERIENCE</p>
        <p className="text-xs" style={{ color: wf.textLight }}>Delivering excellence since 2007</p>
      </div>
    </div>
  </div>
</section>
      ...
      <section id="wf-overview" className="py-20 px-4" style={{ background: "linear-gradient(135deg, #f8f4f0, #f0e8e0)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold mb-6" style={{ color: wf.dark, fontFamily: "'Poppins', sans-serif" }}>
                MOST ADMIRED BRAND OF CENTRAL INDIA
              </h2>
              <p className="text-base leading-relaxed mb-4" style={{ color: wf.textLight }}>
                Wallfort is name synonymous with Quality, Delivery and Transparency. With landmark projects like Wallfort City, Wallfort Enclave - I, Wallfort Orchid etc. we have come to understand the actual need of the house owner and its dwellers.
              </p>
              <p className="text-base leading-relaxed" style={{ color: wf.textLight }}>
                But the most important thing we take pride in is the trust our patrons have bestowed upon us and the fact that we have always upheld it over the years. Currently executing 17+ projects at various locations in the city of Raipur, Wallfort is a single place for all budgets and requirements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li className="flex items-center gap-2"><Phone className="w-4 h-4" /> +91 7999983093, 9399492809, 7000596002</li>
