      ...
      <div className="border-t border-border pt-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <textarea
            ...
            disabled={isSubmitting}
            rows={3}
            className="w-full bg-background border border-input rounded-lg px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-50 resize-none"
          />
          <label className="flex items-start gap-2 text-xs text-muted-foreground">
            <input 
              type="checkbox" 
