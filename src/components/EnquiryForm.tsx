  ...
  return (
    <div id="enquiry" className="w-full glass-card rounded-xl p-6 space-y-4">
      <div className="flex gap-2 mb-2">
        <a
          href="#"
          className="flex-1 bg-primary text-primary-foreground text-center py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition"
        >
          Organize Site Visit
        </a>
        <a
          href="https://api.whatsapp.com/send?phone=919035032000&text=Hi!"
          target="_blank"
      ...
      <div className="border-t border-border pt-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            className="w-full bg-background border border-input rounded-lg px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
          />
          <input
            type="tel"
          ...
          <button
            type="submit"
            className="w-full bg-primary text-primary-foreground py-3 rounded-lg font-bold text-sm hover:opacity-90 transition"
          >
            Pre-Register Now
          </button>
        </form>
