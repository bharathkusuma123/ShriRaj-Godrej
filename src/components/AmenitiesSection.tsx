...
import {
  Waves, Trees, Dumbbell, Baby, ShieldCheck, Cctv,
  Church, Droplets, Building2, CircleDot, Volleyball, Fence,
  Sunset, Trees as Lawn, Building, Users, Flower2,
  Weight, Gamepad2, Hotel, PartyPopper, Leaf, Footprints,
  Sparkles, LayoutGrid
} from "lucide-react";

const amenities = [
  { icon: Volleyball, label: "Basketball Court" },
  { icon: Lawn, label: "Lawn Terraces" },
  { icon: Building, label: "Clubhouse with Gymnasium" },
  { icon: Baby, label: "Kids Play Area" },
  { icon: Waves, label: "Swimming Pool" },
  { icon: Footprints, label: "Jogging Track" },
  { icon: Sparkles, label: "Skating Ring" },
  { icon: LayoutGrid, label: "Multipurpose Lawn" },
