    ...
    <footer className="bg-gradient-forest text-cream">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-cream/60 text-sm leading-relaxed">
              Premium plotted development at Boriyakala, New Dhamtari Road, Raipur. T&C Approved • RERA Approved. Covered campus with world-class amenities.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-cream/60">
              <p className="flex items-center gap-2"><Phone className="w-4 h-4 text-gold" /> +91 90350 32000</p>
              <p className="flex items-center gap-2"><Mail className="w-4 h-4 text-gold" /> info@goldenresidency.com</p>
              <p className="flex items-center gap-2"><MapPin className="w-4 h-4 text-gold" /> Boriyakala, New Dhamtari Road, Raipur</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-cream/10 mt-8 pt-6 text-center text-xs text-cream/40">
          ...
          <p className="mt-2">© 2026 Golden Residency. All rights reserved. T&C Approved | RERA Approved</p>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-forest-deep/95 backdrop-blur-md border-t border-primary/20 py-3 px-4 flex items-center justify-center gap-4 lg:hidden">
        ...
        <a
          href="https://api.whatsapp.com/send?phone=919035032000&text=Hi!%20I'm%20Interested%20In%20Golden%20Residency"
          target="_blank"
